...
jumps to blocks containing a specific pattern of instructions by a copy of these instructions.
This corresponds to inlining of simple, small solidity functions. In particular, the sequence
...
Now ideally, the other optimiser steps described above will result in the return tag being moved
...
the expected number of executions of the contract (which is given as global optimiser parameter).
